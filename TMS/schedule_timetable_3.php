...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    header("location:schedule_timetable_4.php?course=$coursename&semester=$semesterselected&section=$section");
...
<head>
    ...
    <title>Schedule Timetable : Choose Section</title>
    <style>
    body {
...
<body>
    <div class="container w-50 maincontainer">
        ...
        while($row=mysqli_fetch_assoc($result)){
            $section=$row["Section"];
            echo '<div class="mb-1"><input  type="radio" id="section" name="section" value="'.$section.'" required>
